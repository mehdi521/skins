...
// Click functions
if (Config.useESX) {
  $("#hunger-switch").click(function() {mta.triggerEvent('change', 'hunger');});
  $("#thirst-switch").click(function() {mta.triggerEvent('change',  'thirst');});
  if (Config.useStress) {
    $("#stress-switch").click(function() {mta.triggerEvent('change',  'stress');});
  };
};
$("#health-switch").click(function () { mta.triggerEvent('change', 'health' ); });
$("#armor-switch").click(function () { mta.triggerEvent('change', 'armor' ); });
$("#stamina-switch").click(function () { mta.triggerEvent('change', 'stamina' ); });
$("#oxygen-switch").click(function () { mta.triggerEvent('change', 'oxygen' ) });
$("#map-switch").click(function () { mta.triggerEvent('change', 'map') });
$("#id-switch").click(function () { mta.triggerEvent('change', 'id' ) });
$("#cinematic-switch").click(function () { mta.triggerEvent('change', 'cinematic' ) });
$("#time-switch").click(function () { mta.triggerEvent('change', 'time' ) });
$("#microphone-switch").click(function () { mta.triggerEvent('change', 'microphone' ) });
